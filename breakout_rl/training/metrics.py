...
METRIC_FIELDS: tuple[str, ...] = (
    ...
    "sample_probability_batch_min",
    "sample_probability_batch_max",
    "effective_sample_size",
    "sampling_effective_sample_size",
    "per_sampling_dispatch_seconds",
    "per_priority_update_dispatch_seconds",
    "replay_size",
    "replay_capacity",
    "replay_occupancy",
    "steps_per_second",
