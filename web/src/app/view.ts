      ...
      <div class="technical-content">
        ...
        <section class="technical-evidence" aria-label="runtime evidence">
          ...
          <div class="technical-facts">
            ...
            <div><span>Observed paddle center X</span><strong data-role="paddle-center-x">—</strong></div>
            <div><span>Position error</span><strong data-role="position-error">—</strong></div>
            <div><span>Requested direction</span><strong data-role="motion-state">STOPPED</strong></div>
            <div><span>Human requested direction</span><strong data-role="human-requested-action">NOOP</strong></div>
            <div><span>ALE button action</span><strong data-role="human-executed-action">NOOP</strong></div>
            <div><span>Requested paddle position X</span><strong data-role="requested-paddle-position">—</strong></div>
            <div><span>Applied paddle target X</span><strong data-role="applied-paddle-target">—</strong></div>
