...
[![四個 action 的估計加入不同 noise 後，max selection 的平均值偏離真實值](https://github.com/Tommyweige/breakout-rl-engineering-private/blob/codex/issue-19-day17/assets/day17/overestimation-bias.png?raw=1)](https://github.com/Tommyweige/breakout-rl-engineering-private/blob/codex/issue-19-day17/assets/day17/overestimation-bias.png)
...
[![同一個 crafted fixture 下 Vanilla 與 Double DQN 的 evaluated value 和最終 target](https://github.com/Tommyweige/breakout-rl-engineering-private/blob/codex/issue-19-day17/assets/day17/dqn-vs-double-targets.png?raw=1)](https://github.com/Tommyweige/breakout-rl-engineering-private/blob/codex/issue-19-day17/assets/day17/dqn-vs-double-targets.png)
