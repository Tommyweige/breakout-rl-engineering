...
- `vectorized-training-100k.json`: fresh 100K N=1/N=4 validation under strict
...
conda run --name breakout-rl-engineering python diagnose_fire_sticky.py --checkpoint runs/day16-finalization-100k-v2/envs-4/checkpoints/step-00100000.pt --contract configs/eval/breakout_contract_v2.json --device cuda --output assets/day16/fire-sticky-diagnostic.json --trace-output assets/day16/fire-sticky-trace.jsonl
conda run --name breakout-rl-engineering python analyze_q_values.py --checkpoint runs/day16-finalization-100k-v2/envs-4/checkpoints/step-00100000.pt --contract configs/eval/breakout_contract_v2.json --device cuda --seeds 101 102 103 104 105 --steps-per-seed 16 --output assets/day16/q-value-diagnostics.json
...
conda run --name breakout-rl-engineering python summarize_day16_evaluation.py --reference-results evaluations/day16-final-10k-envs1-contract-v2/results.json --reference-checkpoint runs/day16-finalization-10k-v2/envs-1/checkpoints/step-00010000.pt --candidate-results evaluations/day16-final-10k-envs4-contract-v2/results.json --candidate-checkpoint runs/day16-finalization-10k-v2/envs-4/checkpoints/step-00010000.pt --candidate-environment-count 4 --screening-training-report assets/day16/vectorized-training.json --validation-reference-results evaluations/day16-final-100k-envs1-contract-v2/results.json --validation-reference-checkpoint runs/day16-finalization-100k-v2/envs-1/checkpoints/step-00100000.pt --validation-candidate-results evaluations/day16-final-100k-envs4-contract-v2/results.json --validation-candidate-checkpoint runs/day16-finalization-100k-v2/envs-4/checkpoints/step-00100000.pt --validation-candidate-environment-count 4 --validation-training-report assets/day16/vectorized-training-100k.json --random-results evaluations/day16-contract-v2-random/results.json --fire-diagnostic assets/day16/fire-sticky-diagnostic.json --q-value-diagnostic assets/day16/q-value-diagnostics.json --overestimation-report assets/day16/overestimation-bias.json --output assets/day16/evaluation-summary.json
