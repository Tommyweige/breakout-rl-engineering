...
- `evaluation-summary.json`: the envs=1 reference and envs=8 throughput
...
```powershell
conda run --name breakout-rl-engineering python benchmark_vectorized_training.py --device cuda --replay-backend gpu --environment-counts 1 2 4 8 --total-steps 10000 --run-root runs/day16-benchmark-final --output assets/day16/vectorized-training.json
...
conda run --name breakout-rl-engineering python evaluate_vectorized_dqn.py --checkpoint runs/day16-benchmark-final/envs-1/checkpoints/step-00010000.pt --config configs/eval/breakout_eval.json --contract configs/eval/breakout_contract_v2.json --device cuda --output-dir evaluations/day16-final-envs1-contract-v2 --evaluation-id day16-final-envs1-contract-v2
conda run --name breakout-rl-engineering python evaluate_vectorized_dqn.py --checkpoint runs/day16-benchmark-final/envs-8/checkpoints/step-00010000.pt --config configs/eval/breakout_eval.json --contract configs/eval/breakout_contract_v2.json --device cuda --output-dir evaluations/day16-final-envs8-contract-v2 --evaluation-id day16-final-envs8-contract-v2
conda run --name breakout-rl-engineering python summarize_day16_evaluation.py --reference-results evaluations/day16-final-envs1-contract-v2/results.json --reference-checkpoint runs/day16-benchmark-final/envs-1/checkpoints/step-00010000.pt --candidate-results evaluations/day16-final-envs8-contract-v2/results.json --candidate-checkpoint runs/day16-benchmark-final/envs-8/checkpoints/step-00010000.pt --output assets/day16/evaluation-summary.json
