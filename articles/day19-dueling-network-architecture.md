...
[![Dueling Network 從共享 Atari features 分成 Value 與 Advantage，再重建四個 Q-values 的結構圖](../assets/day19/dueling-network-architecture.png?raw=1)](../assets/day19/dueling-network-architecture.png)
...
[![一個真實 Contract v2 Breakout state 的 Value、raw Advantage、centered Advantage 與 Q-values](../assets/day19/dueling-value-advantage-q.png?raw=1)](../assets/day19/dueling-value-advantage-q.png)
...
完整 machine-readable 數值保留在 [Day 19 V/A/Q evidence](../assets/day19/dueling-value-advantage-q.json)。
...
完整效能與環境資訊放在 [Day 19 runtime evidence](../assets/day19/dueling-smoke-runtime.json) 與 [Day 19 smoke report](../assets/day19/day19-dueling-smoke.md)。
