...
[![DQN training loop 分成收集經驗與更新模型兩個不同節奏，Replay Buffer 位在兩者之間](../assets/day12/dqn-training-loop-overview.svg?raw=1)](../assets/day12/dqn-training-loop-overview.svg)
...
[![固定 seed 42 的 Breakout DQN smoke run：真實遊戲畫面與 step、epsilon、raw score、training phase](../assets/day12/training-smoke.gif?raw=1)](../assets/day12/training-smoke.gif)
...
[![Day 12 真實 CPU smoke run 的 raw episode return、Huber loss、selected Q mean 與 epsilon](../assets/day12/training-overview.png?raw=1)](../assets/day12/training-overview.png)
