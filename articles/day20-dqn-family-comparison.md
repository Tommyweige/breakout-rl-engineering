...
[![Day 20 從 500K 比較、發現 seed 方向不一致，到 top-2 延長 1M 並選出 Dueling Double DQN 的簡化流程](../assets/day20/family-selection-flow-simple.svg?raw=1)](../assets/day20/family-selection-flow-simple.svg)
...
[![三個 DQN family 在 actual environment transitions 軸上的 raw episode return 與 20-episode rolling mean；每條線保留 training seed](../assets/day20/dqn-family-training.png?raw=1)](../assets/day20/dqn-family-training.png)
...
[![固定 Contract v2 evaluation 下三個 family、各 training seed 在 100K、250K、500K 和 top-2 的 1M extension 的回報](../assets/day20/dqn-family-evaluation.png?raw=1)](../assets/day20/dqn-family-evaluation.png)
...
[![500K main 的 seed-level return spread；每個點是 training seed，誤差棒是固定 evaluation 的 episode spread](../assets/day20/dqn-family-seed-spread.png?raw=1)](../assets/day20/dqn-family-seed-spread.png)
...
[![500K main 的實測 SPS、wall-clock、peak allocated CUDA memory 和 parameter count](../assets/day20/dqn-family-runtime-cost.png?raw=1)](../assets/day20/dqn-family-runtime-cost.png)
...
完整 machine-readable evidence 保留在 [Day 20 comparison report](../assets/day20/comparison-report.json) 與 [Day 18 reuse audit](../assets/day20/evidence-reuse-audit.json) 中。
