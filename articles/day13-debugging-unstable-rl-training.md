...
[![從數值檢查、固定 batch 到探索訊號與最後超參數調整的 RL 除錯流程](../assets/day13/debugging-workflow.png?raw=1)](../assets/day13/debugging-workflow.png)
...
[![10K-step CUDA debug run 的 Huber loss 曲線，尖峰代表部分 batch 的誤差較大](../assets/day13/loss-curve.png?raw=1)](../assets/day13/loss-curve.png)
...
[![10K-step CUDA debug run 的所有 action Q-values 與 Bellman targets](../assets/day13/q-values.png?raw=1)](../assets/day13/q-values.png)
...
[![10K-step CUDA debug run 的 gradient norm 曲線，數值取 clipping 前的總 norm](../assets/day13/gradient-norm.png?raw=1)](../assets/day13/gradient-norm.png)
...
[![10K-step CUDA debug run 的 raw episode return 曲線](../assets/day13/return-curve.png?raw=1)](../assets/day13/return-curve.png)
