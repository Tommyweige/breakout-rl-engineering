...
[![四個 action 的估計加入不同 noise 後，max selection 的平均值偏離真實值](../assets/day17/overestimation-bias.png?raw=1)](../assets/day17/overestimation-bias.png)
...
[![DQN 與 Double DQN 的核心差異：DQN 直接對 Target Network 取 max；Double DQN 由 Online Network 選 action、Target Network 評估](../assets/day17/dqn-vs-double-dqn-core.svg?raw=1)](../assets/day17/dqn-vs-double-dqn-core.svg)
...
[![同一組 next-state Q-values 下 Vanilla 與 Double DQN 的 target 差異](../assets/day17/dqn-vs-double-targets.png?raw=1)](../assets/day17/dqn-vs-double-targets.png)
...
[![Day 17 smoke checkpoint 在固定 Breakout states 上的 Q-value 分布與 greedy action](../assets/day17/q-probe-summary.png?raw=1)](../assets/day17/q-probe-summary.png)
...
[![相同訓練條件下 Vanilla DQN 與 Double DQN 的短程執行成本](../assets/day17/smoke-performance.png?raw=1)](../assets/day17/smoke-performance.png)
