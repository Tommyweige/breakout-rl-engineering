...
[![DQN 與 Double DQN 從 100K 訓練到 500K 的每局分數變化](../assets/day18/dqn-vs-double-training.png?raw=1)](../assets/day18/dqn-vs-double-training.png)
...
[![Day 18 簡化流程：固定條件，100K 看是否開始學，250K 拉長觀察，500K 用三組 seed 正式比較，再固定測試 15 局](../assets/day18/staged-comparison-flow.svg?raw=1)](../assets/day18/staged-comparison-flow.svg)
...
[![500K 時三組 training seed 的 DQN 與 Double DQN 固定測試分數配對比較](../assets/day18/paired-seed-comparison.png?raw=1)](../assets/day18/paired-seed-comparison.png)
...
[![同一批固定 Breakout states 下，DQN 與 Double DQN 的 Q-value 估計比較](../assets/day18/q-probe-comparison.png?raw=1)](../assets/day18/q-probe-comparison.png)
...
[![500K 階段 DQN 與 Double DQN 的速度、時間與 GPU 記憶體比較](../assets/day18/runtime-comparison.png?raw=1)](../assets/day18/runtime-comparison.png)
