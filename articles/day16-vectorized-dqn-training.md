...
[![Day 16 向量化 DQN Trainer 資料流](../assets/day16/vectorized-pipeline-reader.svg?raw=1)](../assets/day16/vectorized-pipeline-reader.svg)
...
[![1、2、4、8 個環境在相同 10K transition budget 下的吞吐與 wall-clock](../assets/day16/vectorized-throughput.png?raw=1)](../assets/day16/vectorized-throughput.png)
...
[![batch size 1、2、4、8、16 的 GPU Replay insertion microbenchmark](../assets/day16/replay-insertion.png?raw=1)](../assets/day16/replay-insertion.png)
...
[![100K vectorized training throughput 與 wall-clock](../assets/day16/vectorized-100k-vectorized-throughput.png?raw=1)](../assets/day16/vectorized-100k-vectorized-throughput.png)
