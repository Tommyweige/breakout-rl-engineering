...
[![Experience Replay 從 transition、Replay Buffer、隨機抽樣到模型輸入的資料流](../assets/day09/replay-data-flow.png?raw=1)](../assets/day09/replay-data-flow.png)
...
[![Replay Buffer wraparound、真實 Breakout 抽樣畫面與記憶體估算](../assets/day09/replay-buffer.png?raw=1)](../assets/day09/replay-buffer.png)
...
[![Replay Buffer 持續加入新 transition，未滿時增加 size，已滿時覆蓋最舊資料](../assets/day09/replay-lifecycle.svg?raw=1)](../assets/day09/replay-lifecycle.svg)
