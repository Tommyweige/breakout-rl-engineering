...
[![Day 21 從三個 fresh seed 經過 1M、2.5M、5M 比較，到 2.5M freeze 與 final holdout 的訓練決策流程](../assets/day21/day21-main-flow.png?raw=1)](../assets/day21/day21-main-flow.png)
...
[![固定評估規則下，各 milestone checkpoint 的 15 局 evaluation 結果](../assets/day21/milestone-evaluation.png?raw=1)](../assets/day21/milestone-evaluation.png)
...
[![三個 fresh seeds 的真實 training return 與 20-episode rolling mean](../assets/day21/long-training-return.png?raw=1)](../assets/day21/long-training-return.png)
...
[![最後選定模型在未參與挑選的 holdout seeds 上的 raw return](../assets/day21/final-holdout.png?raw=1)](../assets/day21/final-holdout.png)
