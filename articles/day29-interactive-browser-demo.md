...
[![Human 與 RL Agent 在瀏覽器裡各自執行 Breakout](../assets/day29/browser-ai-demo.png?raw=1)](../assets/day29/browser-ai-demo.png)
...
[![Python 與 Browser preprocessing 的逐像素比較](../assets/day29/preprocessing-parity-comparison.png?raw=1)](../assets/day29/preprocessing-parity-comparison.png)
...
[![WASM 與 WebGPU 的 30 局 Breakout 分數分布](../assets/day29/browser-policy-score-distribution.png?raw=1)](../assets/day29/browser-policy-score-distribution.png)
